export const DESKTOP_APPS = [
  ...
  },
  {
    ...
    homeBackground: 'rgba(52,199,89,0.2)',
    previewBackground: 'linear-gradient(180deg, #34C759 0%, #1FA447 100%)'
  },
  {
    key: 'persona',
  ...
  },
  {
    ...
    label: '联系人',
    route: '/phone',
    icon: 'ph-fill ph-address-book',
    homeBackground: 'rgba(0,122,255,0.2)',
    previewBackground: 'linear-gradient(180deg, #007AFF 0%, #0055CC 100%)'
  },
  {
    key: 'planner',
    label: '日程',
  ...
  },
  {
    ...
    homeBackground: 'rgba(251,146,60,0.2)',
    previewBackground: 'linear-gradient(180deg, #D4956A 0%, #8B5E3C 100%)'
  }
]
