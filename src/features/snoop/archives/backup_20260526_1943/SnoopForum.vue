      ...
      <div class="snoop-forum-detail">
        ...
        <div class="snoop-forum-comments-section">
          ...
          >
            ...
            <div v-else class="snoop-forum-comment-avatar" :style="{ background: randomColor(comment.username) }">
            ...
            <div v-if="comment.replies?.length" class="snoop-forum-nested-replies">
              ...
              >
                ...
                <div v-else class="snoop-forum-comment-avatar snoop-forum-nested-avatar"
