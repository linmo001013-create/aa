...
朋友的名字和关系由你根据{{char}}的身份设定。名字要用真实感强的全名（如：陈曦、张明宇、李雨桐、周子涵），避免"阿X""小X"或叠字名。聊天中可能提到{{user}}。
...
用户名要有真实感，使用真实感强的全名（如：陈曦、张明宇、李雨桐、周子涵），避免"阿X""小X"或叠字名，不要用"用户123"这类。给每个评论随机分配0-5个赞。
...
用户名要有真实感，使用真实感强的全名（如：陈曦、张明宇、李雨桐、周子涵），避免"阿X""小X"或叠字名，不要用"用户123"或"匿名网友"这种。给回复随机分配0-5个赞。`)
