  ...
  <div class="snoop-tab-content">
    ...
    <template v-else>
      <div
        ...
        :class="{ 'snoop-browser-item--selecting': selectable }"
        @click="selectable && $emit('toggle-select', idx)"
      >
...
.snoop-browser-item--selecting {
  cursor: pointer;
}

.snoop-browser-item--selecting:active {
  background: rgba(0, 0, 0, 0.03);
}

.dark .snoop-browser-item--selecting:active {
